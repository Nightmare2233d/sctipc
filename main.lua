...
TeleportTab.oob['arcade lobby'].MouseButton1Click:Connect(function()
	wait(.1)
...
PlayerTabStatus.respawn.MouseButton1Click:Connect(function()
  ...
  task.wait(1)
  hintModule = hintModule = require(game:GetService("Players").LocalPlayer.PlayerGui.hud[".scripts"].mainHud.hintModule)
end)
